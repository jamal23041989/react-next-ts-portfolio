...
const ContactForm = () => {
  ...
  const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setSpinner(true)
    emailjs.sendForm('service_4406d2p', 'template_2y49n2e', formRef.current, 'ARtfb1bp4SELm6yXa').then(
      result => {
        setSpinner(false)
  ...
  return (
    <form onSubmit={sendEmail} className={styles.contact__form} ref={formRef}>
      ...
      <ContactInput text="Должность/компания" placeholder="Укажите вашу должность/компанию" type="text" name="company" />
